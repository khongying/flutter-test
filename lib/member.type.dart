...
List<MemberType> memberTypeFromJson(String str) => List<MemberType>.from(json.decode(str).map((x) => MemberType.fromJson(x)));

String memberTypeToJson(List<MemberType> data) => json.encode(List<dynamic>.from(data.map((x) => x.toJson())));
